...
@Component({
    selector: "roomform-component",
    templateUrl: '../../../templates/nurse/patientRoom/roomRegister/index.html',
    styleUrl: '../../../templates/nurse/patientRoom/roomRegister/styles.less'
})
